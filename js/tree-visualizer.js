    ...
    $.fn.treeVisualizer = function(xml, options) {
        ...
        function initVars() {
            ...
            if (args.normalView) {
                ...
                SS = instance.find(".tree-visualizer");
                ...
                trees.push(instance.find(".tree-visualizer .tree"));
                tooltips.push(instance.find(".tree-visualizer .tooltip"));
            }
            if (args.fsView) {
                instance.append('<div class="tree-visualizer-fs" style="display: none"></div>');
                FS = instance.find(".tree-visualizer-fs");
                var FSHTML = "";
                if (!args.normalView) {
                    SSHTML += '<div class="tv-error" style="display: none"><p></p></div>';
                }
                ...
                trees.push(instance.find(".tree-visualizer-fs .tree"));
                tooltips.push(instance.find(".tree-visualizer-fs .tooltip"));
            }
